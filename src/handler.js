...
const addBook = (request, h) => {
  ...
  // ReadPage yang lebih besar dari nilai properti pageCount
...
const updateBook = (request, h) => {
  ...
  // User tidak mengisi name pada request body
  if (!name) {
    const response = h
      .response({
        status: 'fail',
  ...
  // idtidak ditemukkan oleh server
  const response = h
    .response({
      status: 'fail',
